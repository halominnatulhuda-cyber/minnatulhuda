...
**File Organization:**
- **HTML Pages**: Multiple page types including home (index.html/index.html), about (tentang.html), unit pages (unit-*.html), achievement pages (prestasi-*.html), gallery pages (galeri-*.html), and registration pages (daftar-*.html)
- **Core Stylesheets**: 
